...
function populateHeader(jsonObj) {
  ...
  headerPara.textContent = 'Brand NEW fancy products not selling at ' + jsonObj['Store'];
...
function Product(jsonObj) {
  ...
  for (let i = 0; i < Product.length; i++) {
    ...
    p1.textContent = 'Price: $' + Product[i].price;
    p2.textContent = 'Features: ' + Product[i].features;
